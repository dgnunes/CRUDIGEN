    ...
    public void create(Cliente cliente) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            try {
                ...
                throw new RollbackFailureException("Ocorreu um erro na tentativa de RollBack da transação.", re);
            }
            throw ex;
        } finally {
            if (em != null) {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findCliente(id) == null) {
                    throw new NonexistentEntityException("O cliente com id " + id + " não está mais cadastrado.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(Integer id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("O cliente com id " + id + " não está mais cadastrado.", enfe);
            }
            em.remove(cliente);
            utx.commit();
        } catch (Exception ex) {
